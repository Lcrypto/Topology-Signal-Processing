...
function lgraph = ResNetgraph(RBs, TX_ant, netWidth,numUnits,unitType)
...
layers = [
    imageInputLayer([RBs*12 TX_ant*2 1],'Name','input')
...
% Output section.
layers = [layers
         convolution2dLayer([3 3],1, 'Padding', 'same','Name','conv_final')
...
skip1 = [convolution2dLayer(1,numF,'Name','skipConv1')
...
skip2 = [convolution2dLayer(1,numF,'Name','skipConv2')
