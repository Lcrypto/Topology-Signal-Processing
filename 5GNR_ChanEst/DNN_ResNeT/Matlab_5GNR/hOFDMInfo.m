...
%   Windowing         - Optional. The number of time-domain samples over 
%                       which windowing and overlapping of OFDM symbols 
%                       is applied, for CP-OFDM scheme only 
...
%                         applied, for CP-OFDM scheme only
